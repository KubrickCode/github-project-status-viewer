...
- add ifix type and improve distinction guide in commit message generator ([44d6ebc](https://github.com/KubrickCode/github-project-status-viewer/commit/44d6ebcfb51f11330c4acd0bd05cbe419a2380ec))
- Added Conventional Commits specifications to the commit command. ([e8746af](https://github.com/KubrickCode/github-project-status-viewer/commit/e8746af7eb1b0e8aca16b1d4a9551707ba46a1d5))
- AI-related documentation and settings replaced ([df32ca3](https://github.com/KubrickCode/github-project-status-viewer/commit/df32ca36925624d0dc8a5bd69bbbc3e8723fcd3d))
- Fix missing README changes ([393dfe3](https://github.com/KubrickCode/github-project-status-viewer/commit/393dfe333574c5b33e23508abf8d89c751bf73a7))
- re-init CLAUDE.md ([49b01cb](https://github.com/KubrickCode/github-project-status-viewer/commit/49b01cbbb0a4f08157b6bbddc402bf5ee4d11f80))
...
- add lint workflow ([33dd13b](https://github.com/KubrickCode/github-project-status-viewer/commit/33dd13bd7a6cb480fd5a9530e89e811382ff5f7d))
- add test server workflow ([5090a02](https://github.com/KubrickCode/github-project-status-viewer/commit/5090a022a617b1a279d455d3900c0ba4e49246aa))
- Added CLAUDE skills to fix dependency versions and related principles ([e3cf6aa](https://github.com/KubrickCode/github-project-status-viewer/commit/e3cf6aa74ed834582b1e8add0e0f476fe188f547))
- Change Discord notification language ([6235d7d](https://github.com/KubrickCode/github-project-status-viewer/commit/6235d7d0991ee7553d70e1e972057181e74cdfab))
- Change the dependabot commit message conventions ([856c462](https://github.com/KubrickCode/github-project-status-viewer/commit/856c462f518803e2d518f591f9dcbb4f9b87f309))
- Change the Discord webhook url environment variable name ([2e27bbb](https://github.com/KubrickCode/github-project-status-viewer/commit/2e27bbb25291a3beca6368dd4ce56b0a80d5e3da))
- **deps:** Bump actions/setup-go from 5 to 6 ([2e84765](https://github.com/KubrickCode/github-project-status-viewer/commit/2e8476506002b12524e5970a2881539127b4402f))
- **deps:** Bump actions/setup-node from 4 to 6 ([410f59b](https://github.com/KubrickCode/github-project-status-viewer/commit/410f59beb2d96f82849e528d9e3e2ebf66d3a623))
- **deps:** Bump extractions/setup-just from 2 to 3 ([a84fc79](https://github.com/KubrickCode/github-project-status-viewer/commit/a84fc798f0019f9e68486694ad5818ae5572243d))
- Fix formatting inconsistency between save and lint execution ([ea3b9cc](https://github.com/KubrickCode/github-project-status-viewer/commit/ea3b9cc73c70df973fcc5e57e93314237be63b51))
- Fix VSCode Prettier to use global module ([a72f3a7](https://github.com/KubrickCode/github-project-status-viewer/commit/a72f3a737339b712a96c03adced97e450ad333ac))
- Fixed a docker-in-docker build failure due to moby-cli lack in Debian trixie. ([55f49c1](https://github.com/KubrickCode/github-project-status-viewer/commit/55f49c172c2441282739dbf40dc4e25375859daf))
- Fixed an error that occurred when a PR author attempted to add themselves as a reviewer. ([2cfc587](https://github.com/KubrickCode/github-project-status-viewer/commit/2cfc587b092e6f0cbea03fb0535318b58a7a62bd))
- Fixed Claude Code re-login issue when rebuilding DevContainer. ([6fd11bc](https://github.com/KubrickCode/github-project-status-viewer/commit/6fd11bcf379314217aef0198fab19f7cead2e3bb))
- implement semantic-release automation for version management and releases ([9db8b3f](https://github.com/KubrickCode/github-project-status-viewer/commit/9db8b3f27470000502cad7f55e1d4fe8a871aa2f))
- Improved the issue of delayed pre-commit lint error detection, resulting in rework. ([f39de85](https://github.com/KubrickCode/github-project-status-viewer/commit/f39de8514d5912989ca4d6fb5a297841af46295c))
- Migrating the package manager from yarn to pnpm ([060acce](https://github.com/KubrickCode/github-project-status-viewer/commit/060acceaa9b8f5e2b7207b1fd9aa9f644350cd66))
- Modify the environment variables in the env file so that they can be used in the shell environment as well ([9d658ea](https://github.com/KubrickCode/github-project-status-viewer/commit/9d658ea467f584146c6381b8509dcd0fb8552b55))
- Modify workflow-specific documents to not be uploaded to git ([5659870](https://github.com/KubrickCode/github-project-status-viewer/commit/56598706d6d3849b3e5049b621c114bb9eee63da))
- Remove unnecessary degits ([48f6304](https://github.com/KubrickCode/github-project-status-viewer/commit/48f63044ed179d572bcd8b6d17f690c08e969c53))
- Removing webhook tokens ([d909784](https://github.com/KubrickCode/github-project-status-viewer/commit/d909784281862db669f56b2c923bd0623724fbd5))
- Set the git action button terminal name ([4adadd0](https://github.com/KubrickCode/github-project-status-viewer/commit/4adadd0f741976c0254dba9204dd32081d3677a3))
- Set the rebuild action button terminal name ([e0d4c6b](https://github.com/KubrickCode/github-project-status-viewer/commit/e0d4c6b8f81eaf7e21ee377485596444819be199))
- Setting global environment variables ([a4942e8](https://github.com/KubrickCode/github-project-status-viewer/commit/a4942e87d7dd0c0a70973153958f9d06068c113b))
- Simplify Claude Code notification to Stop event only ([286bf03](https://github.com/KubrickCode/github-project-status-viewer/commit/286bf039ac5ab8078f5fbaa95c9100269c34e2dc))
- sync ai agent configurations from general ([7572301](https://github.com/KubrickCode/github-project-status-viewer/commit/7572301cb1d6ceb98e886341bbcc01fa73d1a2ce))
- sync container configurations from general ([7de176f](https://github.com/KubrickCode/github-project-status-viewer/commit/7de176f64389b56ca8609078db9323a3b1663ab6))
- sync lint configurations from general ([f0edae9](https://github.com/KubrickCode/github-project-status-viewer/commit/f0edae9e140efd0cd7d33dfc40364e90d1a17265))
- Sync prompts from the ai-config-toolkit repository ([7ddaa91](https://github.com/KubrickCode/github-project-status-viewer/commit/7ddaa91b43567ffee4530662785d3b9ef30e9b65))
- sync workflow configurations from general ([ed61203](https://github.com/KubrickCode/github-project-status-viewer/commit/ed612033ffab2edef6ae0e5843358a2e45fee1de))
- Synchronizing code from the ai-config-toolkit repository ([4ee8b02](https://github.com/KubrickCode/github-project-status-viewer/commit/4ee8b020702bb64d8ac13e77846fd59fe648c89f))
